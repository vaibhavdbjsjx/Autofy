    ...
    <div id="payments-management-panel" className="space-y-6 font-sans" style={{ color: "var(--text)" }}>
      ...
      <div className="p-6 bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl space-y-4">
        ...
        {filteredTransactions.length === 0 ? (
          <div className="text-center p-12 border border-[var(--border)] rounded-3xl bg-[var(--bg-card)] max-w-md mx-auto space-y-4">
            ...
            <div className="space-y-1">
              <p className="text-[var(--text)] text-sm font-bold">No payment transactions yet</p>
              <p className="text-[11px] text-[var(--text-muted)] leading-relaxed">
                Payments collected from customers through WhatsApp checkout links and invoices will appear here in real-time.
              </p>
            </div>
            <div className="pt-2">
              <button
                onClick={() => setIsPayLinkModalOpen(true)}
                className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl text-xs font-bold transition inline-flex items-center gap-1.5 cursor-pointer shadow-lg"
              >
