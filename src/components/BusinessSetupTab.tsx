...
Status: READY - Gemini cognitive layer successfully trained.`;
  ...
  return (
    <div className="space-y-8 pb-16 font-sans">
      ...
      <div className="relative p-6 md:p-8 rounded-3xl bg-neutral-950/40 border border-var(--border) overflow-hidden backdrop-blur-xl flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-[0_12px_40px_rgba(0,0,0,0.5)]">
        {/* Visual Purple glowing effect behind header */}
        <div className="absolute top-0 right-0 w-[400px] h-[150px] bg-blue-500/10 rounded-full blur-[80px] pointer-events-none" />
        
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 border border-blue-500/20 text-blue-400 font-extrabold text-[10px] uppercase tracking-widest rounded-full font-mono">
            AI Foundation Engine
          </div>
          <h1 className="text-2xl md:text-3xl font-black text-white tracking-tight">
            Business Setup Center
          </h1>
          <p className="text-xs md:text-sm text-neutral-400 max-w-2xl leading-normal">
        ...
        <div className="shrink-0 flex items-center gap-4 bg-var(--bg-elevated)/60 border border-var(--border) p-4 rounded-2xl relative">
          ...
          <button
            ...
            className="px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-xl text-xs font-extrabold transition-all duration-200 cursor-pointer flex items-center gap-1.5 shadow-[0_4px_16px_rgba(37,99,235,0.25)] hover:shadow-[0_4px_20px_rgba(37,99,235,0.4)] active:scale-95"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* SECTION 1: BUSINESS INFORMATION */}
          <div className="p-6 md:p-8 rounded-3xl bg-neutral-950/40 border border-var(--border) backdrop-blur-md space-y-6 shadow-md shadow-black/30 group hover:border-neutral-800 transition-all duration-300">
            <div className="flex items-center gap-3 border-b border-var(--border) pb-4">
              <div className="w-9 h-9 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 shadow-[0_0_15px_rgba(59,130,246,0.1)]">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-500 mt-0.5">Configure core profile data and geographic coordinates.</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-neutral-300">
              
              {/* Business Name */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Business Name</label>
                <input
                  type="text"
                  value={setupState.businessName}
                  onChange={(e) => handleChange("businessName", e.target.value)}
                  placeholder="E.g. Autofy Prime Fitness"
                  className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-xl p-3 text-xs text-white placeholder-neutral-600 focus:outline-none transition-all"
                />
              </div>

              {/* Business Category */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Business Category</label>
                <select
                  value={setupState.businessCategory}
                  onChange={(e) => handleChange("businessCategory", e.target.value)}
                  className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-xl p-3 text-xs text-neutral-300 focus:outline-none transition-all cursor-pointer"
                >
              ...
              {/* Phone Number */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Phone Number</label>
                <input
                  type="text"
                  value={setupState.phoneNumber}
                  onChange={(e) => handleChange("phoneNumber", e.target.value)}
                  placeholder="+91 98765 01234"
                  className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-xl p-3 text-xs text-white placeholder-neutral-600 focus:outline-none font-mono transition-all"
                />
              </div>

              {/* Email Address */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Business Email Address</label>
                <input
                  type="email"
              ...
              {/* Website Domain */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Website URL</label>
                <input
                  type="url"
              ...
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Google Maps Location Link</label>
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-xl py-3 pl-3 pr-10 text-xs text-white placeholder-neutral-600 focus:outline-none font-mono transition-all"
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-500 hover:text-blue-400 cursor-pointer">
            ...
            <div className="flex items-center justify-between border-b border-var(--border) pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-neutral-500 mt-0.5">Allot operational hours and holiday schedules for the database calendar.</p>
                </div>
              </div>

              {/* Universal holiday indicator */}
              <div className="text-[10px] text-neutral-400 bg-[#0c0c0e] border border-var(--border) rounded-xl py-1 px-3 flex items-center gap-1.5">
              ...
              {setupState.workingHours.map((hour, idx) => (
                <div
                  ...
                  className={`p-3.5 rounded-2xl border transition-all duration-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4 ${
                    hour.isHoliday 
                      ? "bg-neutral-950/50 border-var(--border)/60 opacity-60" 
                      : "bg-[#060608]/90 border-var(--border) hover:border-neutral-800"
                  }`}
                >
                  ...
                  <div className="flex items-center gap-4">
                    <button
                      ...
                      className={`w-5 h-5 rounded-lg border flex items-center justify-center transition-all ${
                        hour.isHoliday 
                          ? "bg-neutral-905 border-neutral-800 text-neutral-500" 
                    ...
                    <div>
                      <p className="text-xs font-bold text-white tracking-wide">{hour.day}</p>
                  ...
                  <div className="flex items-center gap-4 self-end sm:self-center">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="w-24 text-center bg-[#09090b] border border-var(--border) p-2 text-xs text-white rounded-xl placeholder-neutral-600 focus:outline-none focus:border-blue-500/40 disabled:opacity-40 disabled:cursor-not-allowed font-mono"
                      />
                    ...
                    <div className="flex items-center gap-1.5 bg-[#09090b] border border-var(--border) py-1 px-3 rounded-xl">
                      <span className="text-[10px] font-bold text-neutral-500">Holiday</span>
                      <button
                        type="button"
                        onClick={() => handleWorkingHourChange(idx, "isHoliday", !hour.isHoliday)}
                        className={`w-7 h-4 rounded-full p-0.5 transition-all outline-none ${
                          hour.isHoliday ? "bg-[#b91c1c]/20 border border-[#ef4444]/30" : "bg-neutral-800"
                        }`}
                      >
                        <div className={`w-3 h-3 rounded-full transition-all ${
                          hour.isHoliday ? "translate-x-3 bg-red-400" : "translate-x-0 bg-neutral-500"
                        }`} />
                      </button>
                    </div>
          ...
          <div className="p-6 md:p-8 rounded-3xl bg-neutral-950/40 border border-var(--border) backdrop-blur-md space-y-6 shadow-md shadow-black/30 group hover:border-neutral-800 transition-all duration-300">
            <div className="flex items-center gap-3 border-b border-var(--border) pb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-500 mt-0.5">Define your core value propositions, services summary and philosophy for LLM injection.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="space-y-1.5">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Detailed description bio</span>
                  <span className="text-neutral-500 text-[10px] font-mono">Generates ~150 word base knowledge index</span>
                </div>
                <textarea
                  rows={4}
                  ...
                  className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-2xl p-4 text-xs text-white placeholder-neutral-600 focus:outline-none leading-relaxed transition-all"
                />
              </div>

              <div className="flex gap-2.5 p-3 rounded-2xl bg-blue-500/5 border border-blue-500/10 text-neutral-400 text-[11px] leading-relaxed">
          ...
          <div className="p-6 md:p-8 rounded-3xl bg-neutral-950/40 border border-var(--border) backdrop-blur-md space-y-6 shadow-md shadow-black/30 group hover:border-neutral-800 transition-all duration-300">
            <div className="flex items-center gap-3 border-b border-var(--border) pb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-500 mt-0.5">Allot priority hotlines for customer escalations and human handover channels.</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              {/* Support Number */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Support hotline</label>
                <input
                  type="text"
              ...
              {/* WhatsApp Number */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">WhatsApp Business hotline</label>
                <input
                  type="text"
              ...
              {/* Alternate Number */}
              <div className="space-y-1.5">
                <label className="text-[10px] uppercase font-black text-neutral-500 tracking-wider">Alternate Backup hotline</label>
                <input
                  type="text"
          ...
          <div className="p-6 md:p-8 rounded-3xl bg-neutral-950/40 border border-var(--border) backdrop-blur-md space-y-6 shadow-md shadow-black/30 group hover:border-neutral-800 transition-all duration-300">
            <div className="flex items-center gap-3 border-b border-var(--border) pb-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-neutral-500 mt-0.5">Index official handles so the chatbot can redirect clients to your social platforms.</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-neutral-300 font-sans">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full bg-[#08080a] border border-var(--border) focus:border-blue-500/50 rounded-xl p-3 text-xs text-white placeholder-neutral-600 focus:outline-none transition-all font-mono"
                />
              </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="p-6 rounded-3xl bg-[#09090b]/90 border border-var(--border) shadow-xl space-y-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h3 className="text-xs font-black text-white uppercase tracking-wider">AI Live Index Auditor</h3>
                <p className="text-[9px] text-neutral-500 font-sans">Visualizes cognitive interpretation in real-time</p>
              </div>
            </div>
            ...
            <div className="space-y-3">
              <span className="text-[9.5px] text-neutral-500 uppercase tracking-wider font-extrabold font-mono">Active Gemini Learned state:</span>
              
              {/* Fake terminal log structure */}
              <div className="bg-[#040406] border border-var(--border) rounded-2xl p-4 font-mono text-[10px] text-neutral-400 leading-relaxed overflow-hidden shadow-inner max-h-[350px] overflow-y-auto">
            ...
            <div className="pt-2">
              <div className="p-3 bg-var(--bg-elevated)/60 border border-var(--border) rounded-2xl text-[9.5px] leading-relaxed text-neutral-400 flex items-start gap-2">
          ...
          <div className="p-6 rounded-3xl bg-neutral-950/60 border border-var(--border) space-y-4">
            <h4 className="text-[10px] font-black text-white uppercase tracking-wider">Active System Checks</h4>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={id} className="flex items-center justify-between text-[11px] p-2 bg-[#09090b]/80 border border-var(--border) rounded-xl">
                  <span className="text-neutral-400 font-sans">{check.label}</span>
                  {check.done ? (
