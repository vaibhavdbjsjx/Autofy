      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-2xl p-4 text-center text-xs">
            <p className="text-[var(--text-muted)] font-bold">Questions on security?</p>
            <p className="text-[10px] text-[var(--text-subtle)] mt-1 mb-3">Enterprise configurations require secure TLS parameters and authorization clearances.</p>
            <a href="/docs/security" target="_blank" className="text-[11px] text-blue-400 hover:text-[var(--text)] font-bold flex items-center justify-center gap-1">
        ...
        <div className="lg:col-span-9 space-y-6">
          ...
          {activeCategory === "profile" && (
            <form onSubmit={handleProfileSave} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
              <div className="border-b border-[var(--border)] pb-4">
                ...
                <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Control how your customer-facing contact references are logged, indexed, and displayed in templates.</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-5 p-4 bg-[var(--bg-elevated)]/10 border border-[var(--border)] rounded-2xl">
                ...
                <div className="space-y-1.5 text-center sm:text-left">
                  <p className="text-xs font-black text-[var(--text)]">Upload New Logo</p>
                  <p className="text-[10px] text-[var(--text-subtle)] leading-normal">Requires PNG or JPEG file. Recommended size 512x512px. Max capacity allocated size 2MB.</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans text-xs">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Business Classification Type</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Contact Phone Number (WhatsApp Node)</label>
                  <input
                    type="text"
                    required
                    value={profile.phone}
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Support Email Address</label>
                  <input
                    type="email"
                    required
                    value={profile.email}
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Website URL Domain</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Operational Business Hours Range</label>
                  <input
                    type="text"
                    required
                    value={profile.hours}
                ...
                <div className="col-span-full space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider flex items-center gap-1">
                    <Globe className="w-3.5 h-3.5 text-[var(--text-subtle)]" /> Default Portal System Timezone
                  </label>
                  <select
          ...
          {activeCategory === "ai" && (
            <form onSubmit={handleAiSave} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
              ...
              <div className="border-b border-[var(--border)] pb-4">
                ...
                <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Finetune cognitive responses, support escalation rules, and system tone metrics to maximize customer conversions.</p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans text-xs">
                
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Assistant Custom Alias</label>
                  <input
                    type="text"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider flex items-center gap-1">
                    <Sliders className="w-3.5 h-3.5 text-[var(--text-subtle)]" /> Response Tone Accent
                  </label>
                  <select
                    value={aiConfig.tone}
                    onChange={(e) => setAiConfig({ ...aiConfig, tone: e.target.value as any })}
                    className="w-full bg-[var(--bg-elevated)] border border-[var(--border)] p-3 rounded-xl text-[var(--text)] focus:outline-none cursor-pointer focus:border-[var(--brand)] capitalize"
                  >
                ...
                <div className="col-span-full space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Automated Welcome Greeting Message</label>
                  <textarea
                    rows={2}
                ...
                <div className="col-span-full space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Automatic Fallback Backup Answer</label>
                  <textarea
                    rows={2}
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Default Response Density/Length</label>
                  <select
                ...
                <div className="space-y-1.5 bg-[var(--bg-elevated)] border border-[var(--border)] rounded-2xl p-4">
                  ...
                  />
                  <p className="text-[9px] text-[var(--text-subtle)] mt-1">Prevents hallucinated info. Checks below {aiConfig.confidenceThreshold}% will instantly trigger fallback route.</p>
                </div>
                ...
                <div className="p-4 bg-[var(--bg-elevated)]/30 border border-[var(--border)] rounded-2xl flex items-center justify-between gap-4">
                  <div>
                    <p className="font-bold text-[var(--text)] text-xs">Human Escalation Routing</p>
                    <p className="text-[10px] text-[var(--text-subtle)] mt-0.5">Auto-flags threads in active chats when client asks for supervisor.</p>
                  </div>
                  <button
                    type="button"
                    onClick={() => {
                  ...
                  >
                    {aiConfig.humanEscalation ? (
                      ...
                      <ToggleLeft className="w-9 h-9 text-[var(--text-subtle)] cursor-pointer" />
                    )}
                  </button>
                </div>
                ...
                <div className="p-4 bg-[var(--bg-elevated)]/30 border border-[var(--border)] rounded-2xl flex items-center justify-between gap-4">
                  <div>
                    <p className="font-bold text-[var(--text)] text-xs">Knowledge auto-update</p>
                    <p className="text-[10px] text-[var(--text-subtle)] mt-0.5">Indexes external catalog modifications automatically to system DB.</p>
                  </div>
                  <button
                    type="button"
                    onClick={() => {
              ...
              <div className="p-4 bg-red-950/10 border border-red-500/10 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="font-sans">
                  ...
                  <p className="text-[10px] text-[var(--text-subtle)] mt-0.5 max-w-md">Erase your customized training datasets of services, catalogs, prices, and restore the base system schema templates.</p>
                </div>
                <button
                  type="button"
                  onClick={() => setDangerConfirmModal("kb")}
                  className="bg-red-950/20 hover:bg-red-900/30 text-red-450 text-red-400 border border-red-500/10 hover:text-[var(--text)] px-4 py-2 rounded-xl text-[10.5px] font-bold transition shrink-0 cursor-pointer"
                >
            ...
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-[var(--border)] pb-4">
                <div>
                  ...
                  <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Control enterprise level access, permissions grants, status trackers, and dashboard logins.</p>
                </div>
                <button
                  onClick={() => setShowInviteModal(true)}
                  className="bg-blue-600 hover:bg-blue-500 text-[var(--text)] font-black text-xs px-4 py-2.5 rounded-xl transition flex items-center gap-1 cursor-pointer self-start sm:self-center shadow-lg"
                >
              ...
              <div className="overflow-x-auto border border-[var(--border)] rounded-2xl bg-[#040406]/60">
                <table className="w-full font-sans text-xs text-left min-w-[600px]">
                  <thead>
                    <tr className="bg-[var(--bg-card)] border-b border-[var(--border)] text-[var(--text-muted)] text-[var(--text-subtle)] text-[10px] uppercase font-black tracking-wider">
                        ...
                        <td className="py-4 px-4 text-right">
                          {member.role !== "Owner" ? (
                            <button
                              ...
                              className="p-1 px-2.5 text-[10px] font-bold text-red-500/80 hover:text-[var(--text)] hover:bg-red-950/20 rounded-lg transition"
                              title="Revoke Teammate Access"
                            >
                              Revoke Access
                            </button>
                          ) : (
                            <span className="text-[10px] text-[var(--text-subtle)] font-mono italic">Primary Access</span>
                          )}
                        </td>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-[var(--bg-elevated)]/25 border border-[var(--border)] rounded-2xl font-sans text-[10.5px]">
                <div>
                  <p className="font-bold text-[var(--text)]">Admin</p>
                  <p className="text-[9.5px] text-[var(--text-subtle)] mt-0.5">Read/write access to AI models, WhatsApp integrations, and API keys credentials configuration.</p>
                </div>
                <div>
                  <p className="font-bold text-[var(--text)]">Manager</p>
                  <p className="text-[9.5px] text-[var(--text-subtle)] mt-0.5">Allowed to view performance analytics reports, edit service catalogs, template responses.</p>
                </div>
                <div>
                  <p className="font-bold text-[var(--text)]">Support Agent</p>
                  <p className="text-[9.5px] text-[var(--text-subtle)] mt-0.5">Can monitor live chats, answer customer escalations, log leads, schedule appointments.</p>
                </div>
              </div>
          ...
          {activeCategory === "notifications" && (
            <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
              ...
              <div className="border-b border-[var(--border)] pb-4">
                ...
                <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Determine how, where, and when your team is alerted of client events and payment milestones.</p>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  {[
                    ...
                    <div key={notif.key} className="p-4 bg-[var(--bg-card)] bg-[var(--bg-elevated)]/50 border border-[var(--border)] rounded-2xl flex items-center justify-between gap-4">
                  ...
                  {[
                    ...
                    <div key={ch.key} className="p-4 bg-[var(--bg-elevated)]/30 border border-[var(--border)] rounded-2xl flex flex-col justify-between gap-4">
                      <div className="flex items-center justify-between">
                        <span className="p-2 rounded-lg bg-[var(--bg-card)] border border-[var(--border)]">{ch.icon}</span>
                        <button onClick={() => toggleNotif(ch.key as any)} className="cursor-pointer">
                          {notifs[ch.key as keyof typeof notifs] ? (
                            ...
                            <div className="toggle-dot w-9 h-5 rounded-full bg-[var(--bg-elevated)] flex items-center justify-start p-0.5"><div className="w-4 h-4 rounded-full bg-[var(--text-subtle)] block" /></div>
                          )}
                        </button>
                      </div>
                      <div>
                        <p className="text-xs font-bold text-[var(--text)]">{ch.label}</p>
                        <p className="text-[9.5px] text-[var(--text-subtle)] mt-0.5">Active stream notifications.</p>
                      </div>
                    </div>
                  ))}
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handlePasswordUpdate} className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
                <div className="border-b border-[var(--border)] pb-4">
                  ...
                  <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Re-verify and reset login credentials. Ensure robust length to pass security standards.</p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 font-sans text-xs">
                  
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Current Passcode</label>
                    <input
                      type="password"
                      placeholder="••••••••••••"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Next Password</label>
                    <input
                      type="password"
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Confirm Next Password</label>
                    <input
                      type="password"
                ...
                <div className="pt-4 border-t border-[var(--border)] flex justify-end">
                  <button
                    type="submit"
                    className="bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] text-[var(--text)] font-bold text-xs px-6 py-2.5 rounded-xl transition cursor-pointer border border-[var(--border)] hover:border-[var(--border-strong)]"
                  >
                    Modify Password
                  </button>
                </div>
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-5">
                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-[var(--border)] pb-4">
                  <div className="font-sans">
                    ...
                    <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Protect developer assets, team logins, and credential parameters against breach.</p>
                  </div>
                  <div>
                    <button
                      onClick={() => {
                      ...
                      className={`text-xs font-black px-4 py-2.5 rounded-xl transition cursor-pointer ${
                        enable2FA ? "bg-red-950/10 hover:bg-red-950/30 text-red-400 border border-red-500/10" : "bg-blue-600 hover:bg-blue-500 text-[var(--text)]"
                      }`}
                    >
                ...
                {enable2FA && (
                  <div className="p-5 bg-[var(--bg-elevated)]/40 border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row items-center gap-5 font-sans">
                    ...
                    <div className="space-y-2 text-xs text-center sm:text-left">
                      <p className="font-bold text-[var(--text)]">Scan Authenticator QR</p>
                      <p className="text-[10.5px] text-[var(--text-subtle)] leading-relaxed max-w-md">Open standard authentication suite (Google Authenticator, Microsoft Auth, or Authy Duo) on your device, parse QR, and input code verification sequence.</p>
                      <div className="flex items-center justify-center sm:justify-start gap-2 pt-1 font-mono">
                        <span className="bg-[var(--bg-elevated)] border border-[var(--border)] px-3 py-1.5 rounded-lg text-[var(--text)] font-bold">129 481</span>
                        <button
                          onClick={() => triggerNotification(" Verified authorization keys!")}
                          className="px-3.5 py-1.5 bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] text-[var(--text)] font-bold text-[10.5px] rounded-lg transition border border-[var(--border)]"
                        >
                          Verify Code
                        </button>
                      </div>
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-5">
                <div className="flex justify-between items-center border-b border-[var(--border)] pb-4">
                  <div>
                    ...
                    <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Audit connected devices and secure locations accessing Autofy.</p>
                  </div>
                  <button
                    onClick={handleLogoutAllDevices}
                    className="p-2 px-3 text-[10.5px] font-bold text-[var(--text-muted)] bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] hover:text-[var(--text)] border border-[var(--border)] rounded-xl transition cursor-pointer"
                  >
                    Logout All Devices
                  </button>
                </div>
                ...
                <div className="space-y-3 font-sans text-xs">
                  {sessions.map((ses) => (
                    <div key={ses.id} className="p-4 bg-[var(--bg)] border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="flex gap-3">
                        <span className="p-2.5 rounded-xl bg-[var(--bg-elevated)] text-[var(--text-muted)] border border-[var(--border)] self-start">
                        ...
                        <div>
                          ...
                          <p className="text-[10.5px] text-[var(--text-subtle)] font-mono mt-0.5 flex items-center gap-1.5">
                            <span>IP Address: {ses.ip}</span>
                            <span>•</span>
                            <span className="flex items-center gap-0.5"><MapPin className="w-3 h-3 text-[var(--text-subtle)]" /> {ses.location}</span>
                          </p>
                        </div>
                      </div>

                      <div className="text-right sm:text-right shrink-0">
                        <span className="text-[10.5px] text-[var(--text-muted)] font-medium font-mono">{ses.date}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 border-b border-[var(--border)] pb-4 animate-fade-in">
                  <div>
                    ...
                    <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Examine usage, metrics allowances, renewal, subscription states and payment details.</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => triggerNotification(" Pricing matrix overlay simulation open.")}
                      className="bg-blue-600 hover:bg-blue-500 text-[var(--text)] font-black text-xs px-4 py-2.5 rounded-xl transition cursor-pointer shadow-lg"
                    >
                      Upgrade Growth Plan
                    </button>
                    <button
                      onClick={() => triggerNotification(" Custom subscription parameters altered.")}
                      className="bg-[var(--bg-elevated)] border border-[var(--border)] hover:border-[var(--border-strong)] text-[var(--text)] font-bold text-xs px-4 py-2.5 rounded-xl transition cursor-pointer"
                    >
                      Cancel Subscription
                    </button>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 font-sans text-xs">
                  ...
                  <div className="bg-[var(--bg)] border border-[var(--border)] rounded-2xl p-5 hover:border-blue-550/20 transition-all">
                    <span className="text-[9.5px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Current Package Tier</span>
                    <h4 className="text-sm font-black text-[var(--text)] mt-1.5 font-sans text-blue-450 text-blue-400">{billingPlan.name}</h4>
                    <p className="text-xl font-bold text-[var(--text)] font-mono mt-1">{billingPlan.cost}</p>
                    <p className="text-[9px] text-[var(--text-subtle)] mt-2 font-mono">Renewal period: {billingPlan.renewalDate}</p>
                  </div>
                  ...
                  <div className="bg-[var(--bg)] border border-[var(--border)] rounded-2xl p-5">
                    <div className="flex justify-between items-center text-[9.5px] uppercase font-black text-[var(--text-muted)]">
                      ...
                      <span className="font-mono text-[var(--text)] text-[11px] font-bold">{billingPlan.messagesUsed}/{billingPlan.messagesLimit}</span>
                    </div>
                    ...
                    <p className="text-[9px] text-[var(--text-subtle)] mt-2">Allocated API tokens reset every 20th of month.</p>
                  </div>
                  ...
                  <div className="bg-[var(--bg)] border border-[var(--border)] rounded-2xl p-5">
                    <div className="flex justify-between items-center text-[9.5px] uppercase font-black text-[var(--text-muted)]">
                      ...
                      <span className="font-mono text-[var(--text)] text-[11px] font-bold">{billingPlan.leadsCaptures}/{billingPlan.leadsLimit}</span>
                    </div>
                    ...
                    <p className="text-[9px] text-[var(--text-subtle)] mt-2">Includes automated Zoho & HubSpot triggers.</p>
                  </div>
                ...
                <div className="p-4 bg-[var(--bg-elevated)]/30 border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-sans text-xs">
                  <div className="flex gap-3">
                    <span className="p-2.5 rounded-xl bg-[var(--bg-elevated)] text-[var(--text-muted)] border border-[var(--border)] flex items-center justify-center">
                      <DollarSign className="w-5 h-5 text-blue-500" />
                    </span>
                    <div>
                      <p className="font-bold text-[var(--text)]">Default Payment Method</p>
                      <p className="text-[10px] text-[var(--text-subtle)] mt-0.5">Linked Visa card: •••• •••• •••• 4242 (Expires 09/2028)</p>
                    </div>
                  </div>
                  <button
                    onClick={() => triggerNotification(" Payment gateway portal billing checkout loaded.")}
                    className="p-2 px-3 text-[10.5px] font-bold text-[var(--text)] bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] hover:text-[var(--text)] border border-[var(--border)] rounded-xl transition cursor-pointer"
                  >
                    Change Method Card
                  </button>
                </div>
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-5">
                <div>
                  ...
                  <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Download past corporate invoices and billing snapshots files.</p>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-6">
                ...
                <div className="border-b border-[var(--border)] pb-4">
                  ...
                  <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Securely integrate custom CRM tools, trigger chat events via code, and automate webhook deliveries.</p>
                </div>
                ...
                <div className="space-y-4 font-sans text-xs">
                  ...
                  <div className="p-4 bg-[var(--bg-card)] bg-[var(--bg-elevated)]/40 border border-[var(--border)] rounded-2xl space-y-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        readOnly
                        value={primaryApiKey}
                        className="flex-1 bg-[var(--bg-elevated)] border border-[var(--border)] p-2.5 rounded-xl text-[var(--text)] font-mono text-[11px] select-all focus:outline-none"
                      />
                      <button
                        onClick={() => setShowApiKey(!showApiKey)}
                        className="px-3.5 py-1.5 bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] text-[var(--text)] rounded-xl transition border border-[var(--border)] text-[10px] cursor-pointer"
                      >
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 justify-between items-start sm:items-center">
                    <button
                      ...
                      className="bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] text-[var(--text)] hover:text-[var(--text)] border border-[var(--border)] hover:border-[var(--border-strong)] text-xs font-black px-4 py-2.5 rounded-xl transition cursor-pointer flex items-center gap-1"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-blue-400 hover:text-[var(--text)] font-black text-xs flex items-center gap-1 cursor-pointer pt-2 sm:pt-0"
                    >
              ...
              <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-3xl p-6 md:p-8 space-y-5">
                <div>
                  ...
                  <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5">Verify that inbound event packets originated indeed from Autofy servers using custom signatures.</p>
                </div>

                <div className="p-4 bg-[var(--bg-elevated)]/30 border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-sans text-xs">
                  <div>
                    <span className="text-[9px] text-[var(--text-subtle)] uppercase font-black">Webhook Secret Signature Hash</span>
                ...
                <div className="p-4 bg-[var(--bg)] border border-[var(--border)] rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-sans text-xs">
                  <div>
                    <p className="font-bold text-[var(--text)]">Rate Limit Information</p>
                    <p className="text-[10px] text-[var(--text-muted)] text-[var(--text-muted)] mt-0.5">Workspace account default restrictions limits.</p>
                  </div>
                  <div className="font-mono text-[var(--text-muted)] text-[10.5px] text-right">
                    <p className="text-[var(--text)] font-bold">1,000 / minute max</p>
          ...
          <div className="bg-red-950/5 border border-red-900/30 rounded-3xl p-6 md:p-8 space-y-5 relative overflow-hidden backdrop-blur-md">
            ...
            <div className="border-b border-red-900/20 pb-4">
              ...
              <p className="text-[10.5px] text-[var(--text-subtle)] mt-0.5 leading-relaxed">Irreversible, dangerous actions. Ensure that all data backups have been finalized prior to executing items below.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 font-sans text-xs">
              
              {/* Danger action 1 */}
              <div className="p-4 bg-[var(--bg-card)] border border-[var(--border)] hover:border-red-900/40 rounded-2xl flex flex-col justify-between gap-3 transition">
                <div>
                  <p className="font-extrabold text-[var(--text)] text-xs">Delete Business Data logs</p>
                  <p className="text-[10px] text-[var(--text-subtle)] leading-normal mt-0.5">Purges all customer chats records history, appointment files logs, and uploaded documents data, keeping account details active.</p>
                </div>
                <button
                  onClick={() => {
                  ...
                  className="bg-red-950/20 hover:bg-red-900 hover:text-[var(--text)] text-red-400 border border-red-500/10 text-[10.5px] font-bold px-4 py-2 rounded-xl transition cursor-pointer self-start"
                >
              ...
              <div className="p-4 bg-[var(--bg-card)] border border-[var(--border)] hover:border-red-900/40 rounded-2xl flex flex-col justify-between gap-3 transition">
                <div>
                  <p className="font-extrabold text-[var(--text)] text-xs">Disconnect WhatsApp Gateway Node</p>
                  <p className="text-[10px] text-[var(--text-subtle)] leading-normal mt-0.5">Terminate live cloud connection with Meta Developer Sandbox. Customers will cease receiving instant automatic answers.</p>
                </div>
                <button
                  onClick={() => {
              ...
              {/* Danger action 3 */}
              <div className="p-4 bg-[var(--bg-card)] border border-[var(--border)] hover:border-red-900/40 rounded-2xl flex flex-col justify-between gap-3 transition col-span-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    <p className="font-extrabold text-[var(--text)] text-xs">Delete Account & Terminate Plan</p>
                    <p className="text-[10px] text-[var(--text-subtle)] leading-normal mt-0.5">Immediately deletes company space and cancels billing subscription. This action cannot be revoked; data becomes permanently destroyed.</p>
                  </div>
                  <button
                    onClick={() => {
                      setDangerConfirmModal("account");
                    }}
                    className="bg-red-600 hover:bg-red-500 text-[var(--text)] font-extrabold text-[10.5px] px-5 py-2.5 rounded-xl transition cursor-pointer shadow-lg"
                  >
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-[var(--border)] pb-3">
                ...
                <button
                  ...
                  className="p-1 hover:bg-[var(--bg-elevated)] text-[var(--text-subtle)] hover:text-[var(--text)] rounded-lg transition"
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <form onSubmit={handleInviteSubmit} className="space-y-4 pt-1">
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Teammate Full Name</label>
                  <input
                    type="text"
                    required
                    ...
                    className="w-full bg-[var(--bg-elevated)] border border-[var(--border)] p-2.5 rounded-xl text-[var(--text)] placeholder-neutral-500 focus:outline-none"
                  />
                </div>

                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Workspace Login Email Address</label>
                  <input
                    type="email"
                    required
                ...
                <div className="space-y-1.5">
                  <label className="text-[10px] uppercase font-black text-[var(--text-subtle)] tracking-wider">Permissions Role Assignment</label>
                  <select
                    value={inviteRole}
                    onChange={(e) => setInviteRole(e.target.value as any)}
                    className="w-full bg-[var(--bg-elevated)] border border-[var(--border)] p-2.5 rounded-xl text-[var(--text)] cursor-pointer focus:outline-none"
                  >
                ...
                <div className="flex gap-2 pt-2">
                  <button
                    type="button"
                    onClick={() => setShowInviteModal(false)}
                    className="flex-1 py-2.5 bg-[var(--bg-elevated)] hover:bg-[var(--bg-elevated)] text-[var(--text-muted)] hover:text-[var(--text)] rounded-xl transition font-bold"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    className="flex-1 py-2.5 bg-blue-600 hover:bg-blue-500 text-[var(--text)] rounded-xl transition font-black text-xs shadow-lg"
                  >
        ...
        {dangerConfirmModal && (
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <div>
                <p className="text-[var(--text)] font-extrabold text-xs">Are you absolutely sure?</p>
                <p className="text-[var(--text-subtle)] leading-relaxed mt-1 text-[11px]">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-2.5 bg-red-600 hover:bg-red-500 text-[var(--text)] rounded-xl transition font-black text-xs shadow-lg"
                >
