...
class Subscription(Base):
    ...
    plan_id = Column(String(50), default="starter", nullable=False) # starter, pro, enterprise
    ...
    # 15-Day Promotional Tracking
    promo_eligible_at_signup = Column(Boolean, default=True, nullable=False)
    ...
    first_cycle_price = Column(Numeric(10, 2), nullable=False, default=300.00)
